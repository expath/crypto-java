...
public class EncryptionWithAesSymmetricKeyAndDefaultProviderAndCbcMode extends BaseTest {
	...
	public void encryptStringWithAesSymmetricKey() throws Exception {
		...
		byte[] encryptionResult = SymmetricEncryption.encrypt(input.getBytes(UTF_8), plainKey, transformationName, iv,
				"");
		byte[] decryptionResult = SymmetricEncryption.decrypt(encryptionResult, plainKey, transformationName, iv, "");
