...
public class HashBinaryWithSha384AndDefaultFormatTest extends BaseTest {
    ...
    public void hashBinaryWithSha384() throws Exception {
        try (final InputStream input = getClass().getResourceAsStream("../keystore.ks")) {
            ...
            assertEquals("DcQ3caBftiQCIQn96Pr8PC2vzs17Re0tZ8/CZnOoucu/N+818uqAXxR7l9oxYgoW", result);
        }
    }
}
