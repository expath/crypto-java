...
public class GenerateEnvelopedDigitalSignatureTest {

    @Test
    public void generateEnvelopedDigitalSignature() throws IOException, CryptoException, XMLSignatureException {
