...
public class HashBinaryWithSha512AndDefaultFormatTest extends BaseTest {
    ...
    public void hashBinaryWithSha512() throws Exception {
        try (final InputStream input = getClass().getResourceAsStream("../keystore.ks")) {
            ...
            assertEquals("Be+hlGy9TNibbaE+6DA2gu6kNj2GS+7b4egFcJDMzQSFQiGgFtTh/mD61ta4pDvc+jqHFlqOyJLH\r\nirkROd86Mw==", result);
        }
    }
}
